...
FIELD(contra_capacity, char, char)
...
FIELD(contra_side, char, char)
VAR_FIELD(symbol, 8)
FIELD(time_in_force, char, char)
FIELD(no_sides, char, unsigned)
FIELD(party_role, char, char)
FIELD(contra_party_role, char, char)
VAR_FIELD(party_id, 4)
VAR_FIELD(contra_party_id, 4)
FIELD(trade_publish_indicator, char, unsigned)
